            ...
            <nav class="navbar navbar-expand-md navbar-light bg-light-blue fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="../Contato/FormCadContatoUsuario.html"><b>Contato</b></a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form class="ms-auto me-2 d-flex">
                        ...
                        <div class="carrinho" style="position: relative; margin-left: 952px;">
        ...
        <main style="margin-top: 10%;">
            <div class="container">
                <div class="row">
                    ...
                    $selecionar = mysqli_query($conn, "SELECT * FROM tb_produto WHERE tipo='colar'");
