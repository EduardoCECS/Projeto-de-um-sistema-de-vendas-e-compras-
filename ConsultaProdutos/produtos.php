                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   ...
                   <ul class="navbar-nav mr-auto">
                    ...
                    <form class="ms-auto me-2 d-flex">
                        <div class="carrinho" style="margin-left: 600px;"> <!-- Remova o position:relative e ajuste a margem esquerda -->
                        ...
                        <!-- Outros elementos do formulário aqui -->
                    </form>
                    ...
                    <form class="ms-auto me-2 d-flex">
                        <<input
                            ...
                            aria-label="Search"
                            name="termo_busca" <!-- Adicionado o name para capturar o valor da busca -->
                            />
            ...
            <div class="container">
                <div class="row">
                    ...
                    if (isset($_GET['termo_busca'])) {
                        ...
                        // Consulta SQL para buscar produtos que correspondem ao termo de busca
                        $query = "SELECT * FROM tb_produto WHERE nome LIKE '%$termo%'";
                        ...
                        if (mysqli_num_rows($selecionar) > 0) {
                            ...
                            echo "<p>Nenhum produto encontrado para: '$termo'</p>";
                        }
                    } else {
                        // Se o formulário não foi enviado, mostrar todos os produtos
                        ...
                        while ($linhas = mysqli_fetch_array($selecionar)) {
                            ...
                            <div class="col-md-4" id="produto-<?php echo $linhas['id_produto']; ?>">
                                <div class="card" style="width: 100%; height: 95%; margin-top: 5%; border-radius: 20px;">
                                    <img src="<?php echo '../img/' . $linhas['imagem']; ?>" class="card-img-top" style="padding: 0; margin: 0; border-radius: 20px; background-size: cover; background-position: center;" width="300px;" height="300px;">
                                    <div class="card-body d-flex flex-column justify-content-center">
                                        <h5 class="card-title text-center"><?php echo "" . $linhas["nome"]; ?></h5>
                                        <p class="card-text text-center"><?php echo "Valor: R$ " . $linhas["valor_venda"]; ?></p>
                                        <p class="card-text text-center"><?php echo "" . $linhas["descricao"]; ?></p>
