...
<html lang="pt-br">
    <head>
        ...
        <link
            ...
            />
        <link rel="stylesheet" href="../css/estilo_fornecedor.css" />
    </head>
        ...
        <main>
            <section id="section-cliente">
                ...
                <div class="d-flex justify-content-center">
                    <form method="post" action="EditarFornecedor.php" id="login">
                        ...
                        <p>
                            ...
                            <input
                                ...
                                required="required"
                                type="text"
                                placeholder="Insira o telefone celular do fornecedor"
                                class="form-control"
                                />
                        </p>
                        ...
                        <p>
                            ...
                            <input
                                ...
                                required="required"
                                type="text"
                                placeholder="Insira o telefone fixo do fornecedor"
                                class="form-control"
                                />
                        </p>
                        ...
                        <p>
                            ...
                            <textarea id="descricao" name="descricao" value="<?= $campo["descricao"] ?>"></textarea>
                        </p>
